...
# --- Configuration ---
s3_input = "s3://sagemaker-us-east-1-266088941084/fuel_prices_clean.csv"
local_output_dir = "C:/Users/Revaun/Projects/sagemaker-petrol-price-demo/output"

# --- Load dataset from S3 ---
print("Downloading dataset from S3...")
s3 = boto3.client("s3")
bucket = "sagemaker-us-east-1-266088941084"
key = "fuel_prices_clean.csv"
local_csv = os.path.join(local_output_dir, "fuel_prices_clean.csv")
...
bst_path = os.path.join(local_output_dir, "xgboost-model")
print(f"Saving model to {bst_path}...")
